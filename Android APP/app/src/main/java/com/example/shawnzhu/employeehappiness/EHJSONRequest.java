...
/**
 * Created by shawnzhu on 2017/9/27.
 */

public class EHJSONRequest extends Request<JSONObject> {
    ...
    public EHJSONRequest(int method, String url, Response.Listener<JSONObject> listener, Response.ErrorListener errorListener) {
        this(method, url, null, listener, errorListener);
    }

    public EHJSONRequest(int method, String url, Map<String, String> params,
